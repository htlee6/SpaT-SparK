...
from timm.models.layers import trunc_normal_, DropPath, DropBlock2d
from timm.models.resnet import make_blocks, Bottleneck, BasicBlock, drop_blocks, get_padding, AvgPool2dSame
...
class LightDecoder(nn.Module):
    def __init__(self, up_sample_ratio, out_chan, width=768, sbn=True):   # todo: the decoder's width follows a simple halfing rule; you can change it to any other rule
        super().__init__()
        self.width = width
        ...
        self.proj = nn.Conv2d(channels[-1], out_chan, kernel_size=1, stride=1, bias=True)
