...
pretrain_default_model_kwargs = {
    ...
    'resnet50_chan1': dict(drop_path_rate=0.05),
    'resnet50_chan12': dict(drop_path_rate=0.05),
    'resnet18_chan1': dict(drop_path_rate=0.05),
    'resnet18_chan12': dict(drop_path_rate=0.05),
    'resnet10_chan12': dict(drop_path_rate=0.05),
    'resnet10_chan1': dict(drop_path_rate=0.05)
}
...
def build_sparse_encoder(name: str, input_size: int, sbn=False, drop_path_rate=0.0, verbose=False, **kwargs):
