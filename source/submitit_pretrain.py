...
import source.pretrain_main as trainer
import submitit
...
def submitit_parse_args():
    ...
    parser = argparse.ArgumentParser("Submitit for SpaT-Spark pretrain", parents=[trainer_parser], add_help=False)
...
class Trainer(object):
    ...
    def __call__(self):
        ...
        trainer.main_pt(args=self.args)
...
def main():
    ...
    executor.update_parameters(name="SpaT-Spark" if args.exp_name == "" else "SpaT-Spark "+args.exp_name)
